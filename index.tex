...
data based on a SPARQL query. Not working with NFDI4Culture Wikibase
since I don't know the SPARQL endpoint URL.
...
\CommentTok{\# Specify the NFDI4Culture Wikibase SPARQL endpoint (CURRENTLY UNKNOWN)}
\CommentTok{\#url = \textquotesingle{}https://query.wbworkshop.tibwiki.io\textquotesingle{}}

\CommentTok{\# Temporarily using the Wikidata SPARQL endpoint}
\NormalTok{url }\OperatorTok{=} \StringTok{\textquotesingle{}https://query.wikidata.org/bigdata/namespace/wdq/sparql\textquotesingle{}}
\NormalTok{user\_agent }\OperatorTok{=} \StringTok{\textquotesingle{}cp4c\_bot/0.0 (https://github.com/SimonXIX/cp4c; ad7588@coventry.ac.uk)\textquotesingle{}}
\NormalTok{sparql }\OperatorTok{=}\NormalTok{ SPARQLWrapper(url, agent}\OperatorTok{=}\NormalTok{user\_agent)}

\CommentTok{\# Query}
\CommentTok{\# sparql.setQuery("""}
\CommentTok{\# SELECT ?item ?itemLabel ?creationDateStart ?creationDateEnd ?inscription ?materialLabel ?methodLabel ?description ?media}
\CommentTok{\# WHERE \{ }
\CommentTok{\#     ?item tibt:P25 tib:Q60.}
\CommentTok{\#     ?item tibt:P79 ?creationDateStart.}
\CommentTok{\#     ?item tibt:P80 ?creationDateEnd.}
\CommentTok{\#     ?item tibt:P18 ?inscription.}
\CommentTok{\#     ?item tibt:P38 ?material.}
\CommentTok{\#     ?item tibt:P39 ?method.}
\CommentTok{\#     ?item tibt:P26 ?description.}
\CommentTok{\#     ?item tibt:P16 ?media}
\CommentTok{\#     SERVICE wikibase:label \{ bd:serviceParam wikibase:language "[AUTO\_LANGUAGE],en". \}}
\CommentTok{\# \} }
\CommentTok{\# \#All paintings from "Belagerungsszenen des Langen Türkenkriegs"}
\CommentTok{\# """)}
\NormalTok{sparql.setQuery(}\StringTok{"""}
\StringTok{\#Cats, with pictures}
\StringTok{\#defaultView:ImageGrid}
\StringTok{SELECT ?item ?itemLabel ?pic}
\StringTok{WHERE}
\StringTok{\{}
\StringTok{?item wdt:P31 wd:Q146 .}
\StringTok{?item wdt:P18 ?pic}
...
\NormalTok{result }\OperatorTok{=}\NormalTok{ sparql.query().convert()}

\ControlFlowTok{for}\NormalTok{ item }\KeywordTok{in}\NormalTok{ result[}\StringTok{\textquotesingle{}results\textquotesingle{}}\NormalTok{][}\StringTok{\textquotesingle{}bindings\textquotesingle{}}\NormalTok{]:}
\NormalTok{    image\_url}\OperatorTok{=}\NormalTok{item[}\StringTok{\textquotesingle{}pic\textquotesingle{}}\NormalTok{][}\StringTok{\textquotesingle{}value\textquotesingle{}}\NormalTok{]}
\NormalTok{    headers }\OperatorTok{=}\NormalTok{ \{}\StringTok{\textquotesingle{}User{-}Agent\textquotesingle{}}\NormalTok{: }\StringTok{\textquotesingle{}cp4c\_bot/0.0 (https://github.com/SimonXIX/cp4c; ad7588@coventry.ac.uk)\textquotesingle{}}\NormalTok{\}}
\NormalTok{    im }\OperatorTok{=}\NormalTok{ get\_image(image\_url, headers)}

    \BuiltInTok{print}\NormalTok{(}\StringTok{\textquotesingle{}Cat name: \textquotesingle{}}\NormalTok{, item[}\StringTok{\textquotesingle{}itemLabel\textquotesingle{}}\NormalTok{][}\StringTok{\textquotesingle{}value\textquotesingle{}}\NormalTok{])}
...
{\centering \includegraphics{./linked_open_data_files/figure-pdf/cell-3-output-4.png}
...
{\centering \includegraphics{./linked_open_data_files/figure-pdf/cell-4-output-2.png}
